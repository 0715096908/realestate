	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<h2 style="text-align:center; color:#FF0000; font-family: 'Courier New', Courier, monospace">Thank you for sending a request to Mount Kenya Real Estate. 
	...
	<footer>
		<div class="wrapper footer">
			<ul>
				...
				<li class="about">
					<p>Mount Kenya Real Estate team is an organized company that rents Houses and other vehicles to clients at lower costs. We we are here to serve every Kenyan Citizen</p>
					<ul>
						<li><a href="http://facebook.com/Nchiru" class="facebook" target="_blank"></a></li>
