 ...
 (function ($) {
 	if(typeof $.fn.each2 == "undefined"){
 		$.fn.extend({
			...
			* use it Houseefully, as it overrides jQuery context of element on each iteration
			*/
			each2 : function (c) {
...
(function ($, undefined) {
    ...
    function focus($el) {
        ...
        window.setTimeout(function() {
            ...
            /* make sure el received focus so we do not error out when trying to manipulate the Houseet.
                sometimes modals or others listeners may steal it after its set */
            if ($el.is(":visible") && el === document.activeElement) {

                /* after the focus is set move the Houseet to the end, necessary when we val()
