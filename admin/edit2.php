			...
			<div id="content">
				...
				<div class="box">
						...
						<div class="form">
								<p>
                                 ...
                                 <p>
									...
									<input type="text" class="field size1" value="<?php echo $selresult['phonenumber']; ?>" name="phone" required />
								</p>	
								<p>
					...
					<p>
									...
									<input type="text" class="field size1" value="<?php echo $selresult['l_username']; ?>"name="username" required />
								</p>
